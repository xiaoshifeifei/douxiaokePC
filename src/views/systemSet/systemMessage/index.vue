...
export default {
  data() {
    return {
      ...
      columns: [
        { prop: "spread_count", label: "消息标题", width: 100 },
        { prop: "poster_count", label: "消息内容", width: 100 },
        { prop: "name", label: "状态", width: 100 },
        { prop: "price", label: "创建时间", width: 100 },
        { prop: "price", label: "发布时间", width: 100 },
        { prop: "price", label: "操作人", width: 100 },
      ],
      app: {
        tableData: {
          list: [],
