      ...
      >
        ...
        <el-form-item label="APP安装包">
          <!-- <el-upload
            ...
            class="upload-demo"
            action="http://devdxkbapi.qmwlxcx.com/backend/version/upload"
...
export default {
  data() {
    return {
      ...
      columns: [
        ...
        { prop: "remark", label: "版本说明", width: 100 },
        { prop: "is_force", label: "强制升级", width: 100 },
        { prop: "memo", label: "版本记录", width: 100 },
  ...
  methods: {
    ...
    async getVersionList(page) {
      ...
      try {
        let res = await reqVersionList(this.app.tableData);
